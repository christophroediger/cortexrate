...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: z.string().trim().optional().default(""),
...
export function getSupabasePublicAuthKey() {
  return (
...
export function getConfigHealth() {
  return {
    ...
    supabaseConfigured: Boolean(env.SUPABASE_URL && getSupabasePublicAuthKey()),
